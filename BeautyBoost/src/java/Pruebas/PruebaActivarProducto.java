...
public class PruebaActivarProducto {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Ingrese el ID del producto a activar: ");
        ...
        try {
            ...
            if (prodExistente != null) {
                ...
                boolean activado = productoDAO.activarProducto(idBusqueda);

                if (activado) {
                    System.out.println("¡El producto ha sido activado con éxito!");
                } else {
                    System.out.println("No se pudo activar el producto.");
                }
