...
public class PruebaInactivarPago {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Ingrese el ID del pago a inactivar: ");
        ...
        try {
            ...
            if (pagoExistente != null) {
                ...
                boolean inactivado = pagoDAO.inactivarPago(idBusqueda);

                if (inactivado) {
                    System.out.println("¡El pago ha sido inactivado con éxito!");
                } else {
                    System.out.println("No se pudo inactivar el pago.");
                }
