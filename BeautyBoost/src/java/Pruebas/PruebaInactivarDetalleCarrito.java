...
public class PruebaInactivarDetalleCarrito {

    public static void main(String[] args) {
        Scanner teclado = new Scanner(System.in);
        DetalleCarritoDAO detalleDAO = new DetalleCarritoDAO();

        System.out.print("Ingrese el ID del detalle de carrito a inactivar: ");
        ...
        try {
            ...
            if (dcExistente != null) {
                ...
                if (inactivado) {
                    System.out.println("¡El detalle de carrito ha sido inactivado con éxito!");
                } else {
                    System.out.println("No se pudo inactivar el detalle de carrito.");
                }
